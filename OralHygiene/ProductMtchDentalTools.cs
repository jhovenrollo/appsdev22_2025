...
{
    public partial class ProductMtchDentalTools: Form
    {
        public ProductMtchDentalTools()
        {
            InitializeComponent();
        }
        ...
        {
            ProductMtchTypesBrush loginForm = new ProductMtchTypesBrush();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchTScraper loginForm = new ProductMtchTScraper();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchFloss loginForm = new ProductMtchFloss();
            loginForm.Show();
            this.Close();
        }
