...
{
    public partial class ReduceTartar: Form
    {
        public ReduceTartar()
        {
            InitializeComponent();
        ...
        {
            ReduceTartarPaste loginForm = new ReduceTartarPaste();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ReduceTartarMouthwash loginForm = new ReduceTartarMouthwash();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ReduceTartarTools loginForm = new ReduceTartarTools();
            loginForm.Show();
            this.Close();
        }
        ...
        private void ReduceTartar_Load(object sender, EventArgs e)
        {
