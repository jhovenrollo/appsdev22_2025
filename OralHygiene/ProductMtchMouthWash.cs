...
{
    public partial class ProductMtchMouthWash: Form
    {
        public ProductMtchMouthWash()
        {
            InitializeComponent();
        }
        ...
        {
            ProductMtchMouthWash1 loginForm = new ProductMtchMouthWash1();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchMouthWash3 loginForm = new ProductMtchMouthWash3();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchMouthWash2 loginForm = new ProductMtchMouthWash2();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchMouthWash4 loginForm = new ProductMtchMouthWash4();
            loginForm.Show();
            this.Close();
        }
