...
{
    public partial class FightingCavitiesMouthwash: Form
    {
        public FightingCavitiesMouthwash()
        {
            InitializeComponent();
            this.Load += FightingCavitiesMouthwash_Load;
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            dialog.Text = "Product Details - ACT Anticavity Fluoride Rinse";
            ...
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Fighting Cavities\Mouthwash\ACT Anticavity Fluoride Rinse.png");
            ...
            lblImageCaption.Text = "ACT Anticavity Fluoride Rinse";
            ...
            lblName.Text = "ACT Anticavity Fluoride Rinse";
            ...
            lblPrice.Text = "Price: Php 355.28";
            ...
            lblDesc.Text = "Strengthens teeth and helps prevent tooth decay.\nFreshens breath with a gentle mint rinse.";
            lblDesc.Font = font14;
        ...
        {
            Form dialog = new Form();
            dialog.Text = "Product Details - Listerine Total Care";
            dialog.FormBorderStyle = FormBorderStyle.FixedDialog;
            dialog.StartPosition = FormStartPosition.CenterParent;
            dialog.ClientSize = new Size(800, 500);
            dialog.MaximizeBox = false;
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Fighting Cavities\Mouthwash\Listerine Total Care1.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblImageCaption = new Label();
            lblImageCaption.Text = "Listerine Total Care";
            lblImageCaption.Font = fontBold16;
            lblImageCaption.ForeColor = Color.Black;
            lblImageCaption.TextAlign = ContentAlignment.MiddleCenter;
            lblImageCaption.Size = new Size(imgPanel.Width, 40);
            ...
            Label lblName = new Label();
            lblName.Text = "Listerine Total Care1";
            lblName.Font = fontBold16;
            lblName.ForeColor = Color.Black;
            lblName.AutoSize = true;
            lblName.Location = new Point(0, 0);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Provides complete oral care with six benefits in one rinse.\nHelps reduce plaque, strengthens teeth, and keeps breath fresh.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        {
            Form dialog = new Form();
            dialog.Text = "Product Details - OraCare Mouthrinse";
            dialog.FormBorderStyle = FormBorderStyle.FixedDialog;
            dialog.StartPosition = FormStartPosition.CenterParent;
            dialog.ClientSize = new Size(800, 500);
            dialog.MaximizeBox = false;
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Fighting Cavities\Mouthwash\OraCare Mouthrinse1231.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblImageCaption = new Label();
            lblImageCaption.Text = "OraCare Mouthrinse";
            lblImageCaption.Font = fontBold16;
            lblImageCaption.ForeColor = Color.Black;
            lblImageCaption.TextAlign = ContentAlignment.MiddleCenter;
            lblImageCaption.Size = new Size(imgPanel.Width, 40);
            ...
            Label lblName = new Label();
            lblName.Text = "OraCare Mouthrinse";
            lblName.Font = fontBold16;
            lblName.ForeColor = Color.Black;
            lblName.AutoSize = true;
            lblName.Location = new Point(0, 0);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Gentle yet effective mouthrinse with stabilized chlorine dioxide.\nNeutralizes bad breath and helps maintain oral hygiene.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        private void FightingCavitiesMouthwash_Load(object sender, EventArgs e)
        {
