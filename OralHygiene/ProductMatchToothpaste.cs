...
{
    public partial class ProductMatchToothpaste: Form
    {
        public ProductMatchToothpaste()
        {
            InitializeComponent();
        }

        private void ProductMtchTthpste_Load(object sender, EventArgs e)
        {
        ...
        {
            ProductMtchColgate loginForm = new ProductMtchColgate();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchFlouride loginForm = new ProductMtchFlouride();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchNonFlouride loginForm = new ProductMtchNonFlouride();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchSensePaste loginForm = new ProductMtchSensePaste();
            loginForm.Show();
            this.Close();
        }
