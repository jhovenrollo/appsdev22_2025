...
{
    public partial class BetterBreathMouthWash: Form
    {
        public BetterBreathMouthWash()
        {
            InitializeComponent();

            this.Load += BetterBreathMouthWash_Load;
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            dialog.Text = "Product Details - Listerine Cool Mint / Total Care";
            ...
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Better Breath\Mouthwash\Listerine Cool Mint Total Care.jpg");
            ...
            lblImageCaption.Text = "Listerine Cool Mint / Total Care";
            ...
            lblName.Text = "Listerine Cool Mint / Total Care";
            ...
            lblPrice.Text = "Price: Php 377.00";
            ...
            lblDesc.Text = "Provides 24-hour protection against plaque and gingivitis.\nFreshens breath and strengthens teeth.";
            lblDesc.Font = font14;
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Better Breath\Mouthwash\TheraBreath23.png");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblPrice = new Label();
            lblPrice.Text = "Price: Php 690.50";
            lblPrice.Font = font14;
            lblPrice.ForeColor = Color.Black;
            lblPrice.AutoSize = true;
            lblPrice.Location = new Point(0, lblName.Bottom + 10);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Clinically proven to fight bad breath for 24 hours.\nGentle, non-burning, and alcohol-free formula.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        {
            Form dialog = new Form();
            dialog.Text = "Product Details - Crest Pro-Health Advanced Mouthwash";
            dialog.FormBorderStyle = FormBorderStyle.FixedDialog;
            dialog.StartPosition = FormStartPosition.CenterParent;
            dialog.ClientSize = new Size(800, 500);
            dialog.MaximizeBox = false;
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Better Breath\Mouthwash\Crest Pro-Health Advanced Mouthwash.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            // Label under image
            Label lblImageCaption = new Label();
            lblImageCaption.Text = "Crest Pro-Health Advanced Mouthwash";
            lblImageCaption.Font = fontBold16;
            lblImageCaption.ForeColor = Color.Black;
            lblImageCaption.TextAlign = ContentAlignment.MiddleCenter;
            lblImageCaption.Size = new Size(imgPanel.Width, 40);
            ...
            Label lblName = new Label();
            lblName.Text = "Crest Pro-Health Advanced Mouthwash";
            lblName.Font = fontBold16;
            lblName.ForeColor = Color.Black;
            lblName.AutoSize = true;
            lblName.Location = new Point(0, 0);
        ...
        {
            Form dialog = new Form();
            dialog.Text = "Product Details - Colgate Plax Mouthwash";
            dialog.FormBorderStyle = FormBorderStyle.FixedDialog;
            dialog.StartPosition = FormStartPosition.CenterParent;
            dialog.ClientSize = new Size(800, 500);
            dialog.MaximizeBox = false;
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\Better Breath\Mouthwash\Colgate Plax Mouthwash.jpeg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            // Label under image
            Label lblImageCaption = new Label();
            lblImageCaption.Text = "Colgate Plax Mouthwash";
            lblImageCaption.Font = fontBold16;
            lblImageCaption.ForeColor = Color.Black;
            lblImageCaption.TextAlign = ContentAlignment.MiddleCenter;
            lblImageCaption.Size = new Size(imgPanel.Width, 40);
            ...
            Label lblName = new Label();
            lblName.Text = "Colgate Plax Mouthwash";
            lblName.Font = fontBold16;
            lblName.ForeColor = Color.Black;
            lblName.AutoSize = true;
            lblName.Location = new Point(0, 0);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Provides 24/7 bad breath control with twice-daily use.\nKills over 99% of germs and gives long-lasting fresh breath.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        private void BetterBreathMouthWash_Load(object sender, EventArgs e)
        {
