...
{
    public partial class FightingCavities: Form
    {
        public FightingCavities()
        {
            InitializeComponent();
            ...
            this.Load += FightingCavities_Load;
        }

        private void pictureBox2_Click_1(object sender, EventArgs e)
        {
            FightingCavitiesPaste loginForm = new FightingCavitiesPaste();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            FightingCavitiesMouthwash loginForm = new FightingCavitiesMouthwash();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            FightingCavitiesTools loginForm = new FightingCavitiesTools();
            loginForm.Show();
            this.Close();
        }
        ...
        private void FightingCavities_Load(object sender, EventArgs e)
        {
