...
{
    public partial class ProductMtchManualBrush: Form
    {
        public ProductMtchManualBrush()
        {
            InitializeComponent();
        }
        ...
        private void ProductMtchManualBrush_Load(object sender, EventArgs e)
        {
        ...
        {
            ProductMtchSoftBristle loginForm = new ProductMtchSoftBristle();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchBrush2 loginForm = new ProductMtchBrush2();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchMediumBristle loginForm = new ProductMtchMediumBristle();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchHardBristle loginForm = new ProductMtchHardBristle();
            loginForm.Show();
            this.Close();
        }
