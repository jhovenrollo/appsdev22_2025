...
{
    public partial class ProductMtchElectricBrush: Form
    {
        public ProductMtchElectricBrush()
        {
            InitializeComponent();
        }
        ...
        {
            ProductMtchEBrush1 loginForm = new ProductMtchEBrush1();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchEBrush2 loginForm = new ProductMtchEBrush2();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchEBrush3 loginForm = new ProductMtchEBrush3();
            loginForm.Show();
            this.Close();
        }
        ...
        {
            ProductMtchEBrush4 loginForm = new ProductMtchEBrush4();
            loginForm.Show();
            this.Close();
        }
