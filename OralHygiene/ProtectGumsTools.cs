...
{
    public partial class ProtectGumsTools: Form
    {
        public ProtectGumsTools()
        {
            InitializeComponent();
            this.Load += ProtectGumsTools_Load;
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\protect Gums\Dental tools\Dental Floss.jpg");
            ...
            lblDesc.Text = "Durable and flexible floss stick.\nSlides easily between teeth for effective cleaning.";
            lblDesc.Font = font14;
        ...
        private void pictureBox4_Click(object sender, EventArgs e)
        {
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\protect Gums\Dental tools\Interdental Brushes.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Removes plaque and food between teeth.\nGentle and flexible for easy cleaning.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        {
            Form dialog = new Form();
            dialog.Text = "Product Details - ORAL B, Pro 2 2000 Electric Toothbrush";
            dialog.FormBorderStyle = FormBorderStyle.FixedDialog;
            dialog.StartPosition = FormStartPosition.CenterParent;
            dialog.ClientSize = new Size(800, 500);
            dialog.MaximizeBox = false;
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\protect Gums\Dental tools\ORAL B, Pro 2 2000 Electric Toothbrush.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblImageCaption = new Label();
            lblImageCaption.Text = "ORAL B, Pro 2 2000 Electric Toothbrush";
            lblImageCaption.Font = fontBold16;
            lblImageCaption.ForeColor = Color.Black;
            lblImageCaption.TextAlign = ContentAlignment.MiddleCenter;
            lblImageCaption.Size = new Size(imgPanel.Width, 40);
            ...
            Label lblName = new Label();
            lblName.Text = "ORAL B, Pro 2 2000 Electric Toothbrush";
            lblName.Font = fontBold16;
            lblName.ForeColor = Color.Black;
            lblName.AutoSize = true;
            lblName.Location = new Point(0, 0);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Removes up to 100% more plaque than a manual brush.\nFeatures a pressure sensor and professional timer.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            PictureBox img = new PictureBox();
            img.Image = Image.FromFile(@"C:\Users\abell\OneDrive\Documents\ImageOralHygiene\UI for Products\protect Gums\Dental tools\Tongue Scraper.jpg");
            img.SizeMode = PictureBoxSizeMode.Zoom;
            img.Dock = DockStyle.Fill;
            imgPanel.Controls.Add(img);
            dialog.Controls.Add(imgPanel);
            ...
            Label lblDesc = new Label();
            lblDesc.Text = "Helps remove bad breath by cleaning the tongue surface.\nImproves oral hygiene and taste sensation.";
            lblDesc.Font = font14;
            lblDesc.ForeColor = Color.Black;
            lblDesc.Size = new Size(420, 60);
            lblDesc.Location = new Point(0, lblPrice.Bottom + 10);
            ...
            Label lblIngredients = new Label();
            lblIngredients.Text = "Includes:\n- 3 Stainless Steel Scrapers\n- Ergonomic Grip\n- Portable Storage Case";
            lblIngredients.Font = font14;
            lblIngredients.ForeColor = Color.Black;
            lblIngredients.Size = new Size(420, 120);
            lblIngredients.Location = new Point(0, lblDesc.Bottom + 10);
        ...
        private void ProtectGumsTools_Load(object sender, EventArgs e)
        {
