...
{
    public partial class ProductMtchSoftBristle: Form
    {
        public ProductMtchSoftBristle()
        {
            InitializeComponent();
        }
        ...
        {
            ProductMtchManualBrush loginForm = new ProductMtchManualBrush();
            loginForm.Show();
            this.Close();
        }
        ...
        private void ProductMtchSoftBristle_Load(object sender, EventArgs e)
        {
