...
namespace oralHygiene
{
    public partial class AboutInfo: Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://www.facebook.com/profile.php?id=61575117630712");
        }
        

        private void Instacon_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.instagram.com/flossence_1/");
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            switch (searchQuery)
            {
                ...
                case "hardtbrush":
                    ...
                    return;
                case "typesofbrush":
                    ShowForm(new ProductMtchTypesBrush());  // Mode Electric Toothbrush
                    return;
